...
from pinvgcn.graphs import load_graph_data
...
data = load_graph_data(args.dataset, lcc=args.lcc)

tic = timer()
data = GraphPinv(rank=args.rank, loop_weights=args.loops, dense_graph=False)(data)
data = data.to(device)
